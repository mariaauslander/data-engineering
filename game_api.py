...
def purchase_a_sword():
    ...
    sword_type={'Zulfiqar':'Double bladed sword','Joyeuse':'Medieval coronation sword','Masamune':'Japanese sword created by Masamune','Curved Saber of San Martin':'Curved saber',
            'Durendal':'Medievel one-handed straight sword','Seven Branched Sword':'Japanese ceremonial sword','Legbiter':'Gaddhjalt sword from Norway','Excalibur':'Sword of King Arthur'}
